...
export type ThreadProps = {
  ...
  hideAttachments?: boolean | undefined;
};
...
export const Thread: FC<ThreadProps> = ({
  ...
  return (
    <ThreadContext.Provider value={{ components, hideAttachments }}>
...
const ThreadRoot: FC<{ isEmpty: boolean }> = ({ isEmpty }) => {
  const {
    components: { Welcome = ThreadWelcome },
...
const Composer: FC = () => {
  const { hideAttachments } = useContext(ThreadContext);
  ...
  return (
    <ComposerPrimitive.Root className="aui-composer-root relative flex w-full flex-col">
      <ComposerPrimitive.AttachmentDropzone asChild>
        ...
        >
          {!hideAttachments && <ComposerAttachments />}
...
const ComposerAction: FC = () => {
  ...
  return (
    <div className="aui-composer-action-wrapper relative flex items-center justify-between">
      {!hideAttachments && <ComposerAddAttachment />}
...
const UserMessage: FC = () => {
  ...
  return (
    <MessagePrimitive.Root
      ...
      data-role="user"
    >
      {!hideAttachments && <UserMessageAttachments />}
